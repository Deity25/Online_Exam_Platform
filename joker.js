...
function setform() {
  ...
  for(var i=0;i<document.forms.length;i++) {
    ...
    //   document.forms[i].addEventListener("submit",submitform(event));
      var j=0;
...
function setdataa() {
  ...
  form.elements["fname"].value = 'digambar';
//   form.elements["middleName"].value = 'chandrakant';
  form.elements["lname"].value = 'kumbhar';
